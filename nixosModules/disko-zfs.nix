...
}:
{
  ...
  config = {
    ...
    # The pool should import only when the on-disk hostid matches this
    # machine's persisted clan hostId. Force-importing a root pool can hide
    # stale imports and risks data loss if the disk is ever attached elsewhere.
