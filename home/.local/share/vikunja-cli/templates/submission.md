...
schema:
  ...
  properties:
    ...
    checklist:
      ...
      maxItems: 5
      description:
        Milestones like requirements checked, package prepared, submitted,
        receipt saved.
    notes:
      type: array
      items:
    ...
    proof:
      ...
      items:
        type: string
      maxItems: 3
      description: Receipt, confirmation email, screenshot, or submitted record.
      minItems: 1
    sources:
      type: array
      items:
...
External form/document/package submission.
