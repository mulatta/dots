#!/usr/bin/env python3
"""
create-gh-app: Helper utility to create GitHub Apps with the correct permissions.

Based on Mic92's create-gh-app script from dotfiles.
"""
...
def parse_args() -> CreateGhAppArgs:
    parser = argparse.ArgumentParser(
        description="Create a GitHub App with the specified permissions"
    )
