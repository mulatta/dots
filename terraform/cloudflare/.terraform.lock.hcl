...
provider "registry.opentofu.org/carlpett/sops" {
  ...
  hashes = [
    ...
    "h1:EVCpb2uGa0miqWiqMnwVZi8kljCXu60Ov9D7OuXS7WI=",
...
provider "registry.opentofu.org/cloudflare/cloudflare" {
  version = "5.19.1"
  hashes = [
    "h1:EGLLthxkBpd7gRjM38gfK0w58+U+DQKblKBm4zu9jLw=",
...
provider "registry.opentofu.org/hashicorp/local" {
  version = "2.9.0"
  hashes = [
    "h1:/4dGOo0BjBBeHxjWyVAhPZgI7PuJrfInnE4on/I+kNM=",
...
provider "registry.opentofu.org/vultr/vultr" {
  ...
  hashes = [
    ...
    "h1:V9nnRTCcFjv4pP0ryfPhzHlBJygv5kKwUA0M7Go8KTs=",
